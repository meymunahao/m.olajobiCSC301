...
//Used ChatGPT in getting an outline of how to go about the project (to help structure my disorganised thoughts. Used in places I kept having errors in, which I needed to correct like (cin.ignore, 
...
queue<Parcel> loadingQueue; //Queue to manage loading parcels (first-come, first-served)
